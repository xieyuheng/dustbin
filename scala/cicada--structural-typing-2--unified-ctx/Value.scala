...
final case class ValuePi(arg_type_map: ListMap[String, Exp], return_type: Exp, ctx: Ctx) extends Value
final case class ValueFn(arg_type_map: ListMap[String, Exp], body: Exp, ctx: Ctx) extends Value
final case class ValueTl(type_map: ListMap[String, Exp], ctx: Ctx) extends Value
